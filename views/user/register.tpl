        ...
        <div id="main">
            <div class="form">
                ...
                <div class="row clearfix">
                    ...
                    <div class="row-dd">
                        <input id="rePassword" type="password" class="layui-input" placeholder="请重复输入密码">
                    </div>
                </div>
                <div class="row clearfix">
                    <div class="row-dt">
                    ...
                    <div class="row-dd">
                        <input id="phone" type="text" class="layui-input" placeholder="请输入手机号码">
                    </div>
                </div>
                <div class="row clearfix">
                    <div class="row-dt">
                    ...
                    <div class="row-dd">
                        <input id="dwPhone" type="text" class="layui-input" placeholder="请输入单位电话">
                    </div>
                </div>
                <div class="row clearfix">
                    <div class="row-dt">
                    ...
                    <div class="row-dd">
                        <input id="addr" type="text" class="layui-input" placeholder="请输入单位地址">
                    </div>
                </div>
                <div class="row clearfix">
                    <div class="row-dt">
                ...
                <div class="row">
                    <a href="javascript:;" class="small-button edit" id="regis">注册</a>
                </div>
            </div>
        </div>
        <footer id="root-foot">
